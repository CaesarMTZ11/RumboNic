...
export function AIHeroCard({ onPress }: AIHeroCardProps) {
    return (
        <Pressable
            accessibilityRole="button"
            accessibilityLabel="Crear ruta inteligente"
            onPress={onPress}
            style={({ pressed }) => [styles.aiHeroWrapper, pressed && styles.pressed]}
        >
            <LinearGradient
                colors={[colors.primary.forest, colors.primary.medium]}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 1 }}
                style={styles.aiHero}
            >
                <View style={styles.aiIconContainer}>
                    <Ionicons name="sparkles" size={25} color={colors.warning} />
                </View>

                <Text style={styles.aiEyebrow}>ASISTENTE INTELIGENTE</Text>

                <Text style={styles.aiTitle}>Planifica tu próximo viaje con IA</Text>

                <Text style={styles.aiDescription}>
                    Crea una ruta personalizada según tu ubicación, tiempo, presupuesto e
                    intereses.
                </Text>

                <View style={styles.aiButton}>
                    <Ionicons name="sparkles" size={18} color={colors.primary.forest} />

                    <Text style={styles.aiButtonText}>Crear ruta inteligente</Text>
                </View>
            </LinearGradient>
        </Pressable>
    );
...
export function DailyRouteCard({ onPress }: DailyRouteCardProps) {
    return (
        <Pressable
            accessibilityRole="button"
            onPress={onPress}
            style={({ pressed }) => [styles.dailyRoute, pressed && styles.pressed]}
        >
            ...
            <Text style={styles.dailyRouteTitle}>Granada y Laguna de Apoyo</Text>

            <Text style={styles.dailyRouteDescription}>
                Cultura colonial, gastronomía local y naturaleza en una aventura de un
                día.
            </Text>
    ...
    return (
        ...
        >
            <View style={styles.destinationImageContainer}>
                ...
                >
                    <Ionicons
                        name={destination.isFavorite ? "heart" : "heart-outline"}
                        size={21}
                        color={destination.isFavorite ? colors.error : colors.text.primary}
                    />
                </Pressable>
        ...
        >
            ...
            <View style={styles.businessContent}>
                <View style={styles.localBadge}>
                    <Ionicons name="storefront-outline" size={14} color={colors.earth} />
                ...
                <Text numberOfLines={1} style={styles.businessCategory}>
                    {business.category}
                </Text>
                ...
                <View style={styles.businessMeta}>
                    ...
                    <Text numberOfLines={1} style={styles.businessLocation}>
                        {business.location}
                    </Text>
